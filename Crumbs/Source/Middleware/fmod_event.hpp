...
namespace FMOD
{
    ...
    */
    class EventSystem
    {
        ...
        // Reverb interfaces.
        virtual FMOD_RESULT F_API setReverbProperties       (const FMOD_REVERB_PROPERTIES *props) = 0;
        virtual FMOD_RESULT F_API getReverbProperties       (FMOD_REVERB_PROPERTIES *props) = 0;

        virtual FMOD_RESULT F_API getReverbPreset           (const char *name, FMOD_REVERB_PROPERTIES *props, int *index = 0) = 0;
        virtual FMOD_RESULT F_API getReverbPresetByIndex    (const int index,  FMOD_REVERB_PROPERTIES *props, char **name = 0) = 0;
        ...
        virtual FMOD_RESULT F_API setReverbAmbientProperties(FMOD_REVERB_PROPERTIES *props) = 0;
        virtual FMOD_RESULT F_API getReverbAmbientProperties(FMOD_REVERB_PROPERTIES *props) = 0;
