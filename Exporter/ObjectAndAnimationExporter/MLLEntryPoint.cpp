...
MStatus initializePlugin( MObject obj )
{
	...
	MFnPlugin plugin(obj, "ED2 Student", "6.0");

	//initializes the plug in using your specific creator function from your file translator
	status = plugin.registerFileTranslator("ED2 Mesh and Scene Exporter", NULL, CFileTranslator::creator /*, "script name", "option paramters"*/ );
...
MStatus uninitializePlugin( MObject obj )
{
	...
	status = plugin.deregisterFileTranslator("ED2 Mesh and Scene Exporter");
